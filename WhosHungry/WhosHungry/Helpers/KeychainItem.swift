...
//  WhosHungry
//
//  Created by Kelsey Sparkman on 9/30/20.
...
struct KeychainItem {
    ...
    static var currentUserIdentifier: String {
        do {
            let storedIdentifier = try KeychainItem(service: "com.DMA.WhosHungry", account: "userIdentifier").readItem()
    ...
    static func deleteUserIdentifierFromKeychain() {
        do {
            try KeychainItem(service: "com.DMA.WhosHungry", account: "userIdentifier").deleteItem()
        } catch {
